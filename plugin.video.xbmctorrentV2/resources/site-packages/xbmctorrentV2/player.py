...
import time
import urlparse
from xbmctorrentV2 import plugin, torrent2http
from xbmctorrentV2.common import RESOURCES_PATH
from xbmctorrentV2.platform import PLATFORM
from xbmctorrentV2.ga import track_event
from xbmctorrentV2.utils import url_get_json
...
class TorrentPlayer(xbmc.Player):
    def init(self, uri, subtitles):
        ...
        if PLATFORM["os"] == "android" and self.torrent2http_options["dlpath"] != ".":
            from xbmctorrentV2.utils import get_path_fs
    ...
    def loop(self):
        from xbmctorrentV2.utils import SafeDialogProgress
