...
class TorrentPlayer(xbmc.Player):
    def init(self, uri):
        ...
        if PLATFORM["os"] == "android" and self.torrent2http_options["dlpath"] != ".":
            from streamajoker.utils import get_path_fs
    ...
    def loop(self):
        from streamajoker.utils import SafeDialogProgress
