from streamajoker.plugin import plugin

PUBLIC_TRACKERS = "&tr=udp://tracker.publicbt.com:80/announce&tr=udp://tracker.openbittorrent.com:80/announce&tr=udp://open.demonii.com:1337/announce&tr=udp://tracker.istole.it:6969&tr=udp://tracker.coppersurfer.tk:80"


# Add default trackers to a magnet link, to improve its reachability
def _boost_magnet():
    from urllib import urlencode
    return "%s" % PUBLIC_TRACKERS
