...
class TorrentPlayer(xbmc.Player):
    ...
    def onPlayBackStarted(self):
        ...
        if getSetting("subtitles") == 'true':
            if not xbmc.Player().getSubtitles(): self.subtitle = subtitles.getsubtitles(self.display_name,tagname, '', '',getSetting("sublang1"),getSetting("sublang2"))			
        xbmc.Player().setSubtitles(self.subtitle)	
