...
from xbmctorrent import subtitles
...
class TorrentPlayer(xbmc.Player):
    ...
    def onPlayBackStarted(self):
        for f in self.on_playback_started:
            f()
        try:
			print '##teste',xbmc.getInfoLabel("VideoPlayer.OriginalTitle"),xbmc.getInfoLabel("VideoPlayer.MPAA")
			...
			try: imdb = xbmc.getInfoLabel("VideoPlayer.MPAA")
			except: imdb = ''
			try: name = xbmc.getInfoLabel("VideoPlayer.OriginalTitle")
			except: name = self.display_name
			if getSetting("subtitles") == 'true': self.subtitle = subtitles.getsubtitles(name,tagname,'', '',getSetting("sublang1"),getSetting("sublang2"),imdb)
